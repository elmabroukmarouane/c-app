...
function RegisterajoutOuModif() {
  swal({
    title: "Loading",
    text: "Please, wait a moment. \n The system is finishing your submission !",
  ...
  $.ajax({
    url: "/c-app/RegisterajoutOuModif",
    type: "POST",
    async: true,
    contentType: false,
    processData: false,
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (
        ...
        var html_questreps = "";
        $.ajax({
          url: "/c-app/get-questions-distinct-id/" + response.user_id,
          type: "GET",
          async: false,
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.found == true) {
        ...
        $.ajax({
          url: "/c-app/sendEmailRecoverPasswordPost",
          type: "POST",
          async: true,
          contentType: false,
          processData: false,
