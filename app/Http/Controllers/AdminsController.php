...
class AdminsController extends Controller
{
    ...
    {
        $admins = User::where('personnes.id_tpersonne', '!=', 3)
                      ->join('personnes', 'users.id_personne', '=', 'personnes.id')
        ...
        if($request->id_status_statuscompte == 1)
        {
            ...
            if($user->firstime == 1)
            {
                ...
                if($result_parraine)
                {
                    ...
                    $balanceaffiliation_parrain->balance_affiliation = $balanceaffiliation_parrain->balance_affiliation + $balanceaffiliationparameter->affiliate_parameter;
                ...
                $balanceaffiliation_parraine->balance_affiliation = $balanceaffiliation_parraine->balance_affiliation + $balanceaffiliationparameter->newcomer_parameter;
