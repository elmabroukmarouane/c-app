    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-4">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="javascript:void(0)" onclick="messages_list = LoadmessagesList(); refresh_table(messages_list)"><i class="fa fa-refresh"></i> Refresh Table</a>
            ...
            <div class="table-responsive m-t-40">
                <table id="messages-list" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                    <tr>
...
@section('scripts')
    ...
    <script type="text/javascript" src="js/ajax/messages/messages.js"></script>
@stop