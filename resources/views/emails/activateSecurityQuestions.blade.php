                            ...
                            <tr>
                                <td align='left' style='padding: 0 56px 28px 56px;' valign='top'>
                                    <div style='font-family: "lato", "Helvetica Neue", Helvetica, Arial, sans-serif; line-height: 28px;font-size: 18px; color: #333;'>
                                        ...
                                        Email : <b>{{ $email }}</b><br />
                                        Please click the following link to re-activate your account.
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td align='left' style='padding: 0 56px;' valign='top'>
                                    <div>
                                        ...
                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"
                                            ...
                                            <w:anchorlock/>
                                        <![endif]-->
                                        <a style="background-color:#007acc;border-radius:50px;color:#ffffff;display:inline-block;font-family: &#39;lato&#39;, &#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif;font-size:18px;line-height:44px;text-align:center;text-decoration:none;width:250px;-webkit-text-size-adjust:none;"
                                           href="{{ $url }}">REACTIVATE ACCOUNT</a>
                                        <!--[if mso]>
                                        </v:roundrect>
                                        <![endif]-->
                                    </div>
