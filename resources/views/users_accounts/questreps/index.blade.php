...
@section('content')
    <script>
        ...
        var count_question_array = <?php echo count($questions_array); ?>
    </script>
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-4">
                    ...
                    <div class="dropdown-menu">
                        @if ($count_questrep < 3)
                        <a id="button_add_dropdown" class="dropdown-item" href="javascript:void(0)" onclick="fill_form_questreps()"><i class="fa fa-plus"></i> Add</a>
                        <div id="divider_add_dropdown" class="dropdown-divider"></div>
                        @endif
                        <a class="dropdown-item" href="javascript:void(0)" onclick="refresh_table(questreps_list)"><i class="fa fa-refresh"></i> Refresh Table</a>
                    </div>
                </div>
            </div>
