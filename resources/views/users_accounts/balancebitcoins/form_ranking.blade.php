<!-- Modal -->
<div id="balancebitcoinsByRankingModal" class="modal fade" role="dialog">
    <div class="modal-dialog">

        <form method="post" id="form-balancebitcoinsByRankingModal" class="form-material m-t-40">
            <!-- Modal content-->
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-line" name="balance_bitcoin_by_ranking" id="balance_bitcoin_by_ranking" placeholder="Enter Balance bitcoin" value="0" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <input type="hidden" id="id_balance_bitcoin_by_ranking">
