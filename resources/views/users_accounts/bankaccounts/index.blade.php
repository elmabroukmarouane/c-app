...
@section('content')
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="javascript:void(0)" onclick="bankaccounts_list = LoadbankaccountsList(); refresh_table(bankaccounts_list)"><i class="fa fa-refresh"></i> Refresh Table</a>
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{route('generatePDF_bankaccounts')}}" target="_blank"><i class="fa fa-file-pdf-o"></i> Generate PDF</a>
                    </div>
                </div>
            </div>
    ...
    @include('users_accounts.bankaccounts.form')
@stop
@section('scripts')
    <script type="text/javascript" src="js/ajax/users_accounts/bankaccounts/bankaccounts.js"></script>
@stop