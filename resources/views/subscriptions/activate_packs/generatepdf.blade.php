...
<head>
    <meta charset="utf-8">
    <title>Sponsors Packs List</title>
    <style>
        table {
...
<body>
<h2 style="text-align: center; font-weight: bold;">Sponsors Packs List</h2><br />
<table class="table">
    <thead>
    ...
    @foreach($data_ontradings as $data_ontrading)
        <tr style="text-align: center;">
            <td>{{ $data_ontrading['id'] }}</td>
            <td>{{ $data_ontrading['nom_prenom'] }}</td>
