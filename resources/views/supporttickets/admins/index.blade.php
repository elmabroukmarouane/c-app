...
@section('content')
    ...
    @include('supporttickets.admins.form')
    @include('supporttickets.admins.form_status')
@stop
@section('scripts')
    <script>
        CKEDITOR.replace('supportticket_message');
    </script>
    <script type="text/javascript" src="js/ajax/supporttickets/admins/supporttickets.js"></script>
@stop